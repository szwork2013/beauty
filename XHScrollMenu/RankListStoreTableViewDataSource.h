...
@interface RankListStoreTableViewDataSource : NSObject<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong) NSMutableArray *dataSourceArray;
@property (nonatomic,strong) RankListStoreViewController *viewController;
